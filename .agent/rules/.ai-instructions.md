...
- **Core (`app/core`)**: [See Core Rules](app/core/.ai-instructions.md)
- **API (`app/api`)**: [See API Rules](app/api/.ai-instructions.md)
- **Infra (`app/infra`)**: [See Infra Rules](app/infra/.ai-instructions.md)
- **Domain (`app/domains`)**: [See Domain Rules](app/domains/.ai-instructions.md)
  - [Tenant Role](app/domains/tenant/README.md)
  - [Subscription Role](app/domains/subscription/README.md)
  - [Agent Role](app/domains/agent/README.md)
  - [Report Role](app/domains/report/README.md)
  - [License Role](app/domains/license/README.md)
- **Common (`app/common`)**: [See Common Rules](app/common/.ai-instructions.md)
